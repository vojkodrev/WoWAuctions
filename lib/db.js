...
module.exports = class Database {
  ...
  async createTables() {
    ...
    // console.log("create pet table");
    // await this.db.run(`CREATE TABLE pet (
  ...
  // async insertPet(name) {
  //   console.log("inserting pet", name);
  ...
  //   return this.db.prepare(`SELECT * FROM pets`);
  // }
